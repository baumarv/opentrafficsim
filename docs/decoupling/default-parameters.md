...
| `vGain` speed-difference scale | **15 km/h** | **30 km/h** | **I** | *Intended value (car 15 km/h, truck 30 km/h); not yet recalibrated jointly with the other parameters; the published results ran with 15 / 30 m/s due to an unintended unit conversion (see tag `campaign-final-v1`).* Decided in Phase 1; see §6. |
