...
| FSM | [**fsm_reengineering_plan.md**](fsm_reengineering_plan.md) | Why Layer 3 is not an FSM in the design-pattern sense, and the staged, trace-verified plan to make it one | `ManeuverPattern`, `ActionState`, `CompositeActionState`, `LateralExecutionState` |
