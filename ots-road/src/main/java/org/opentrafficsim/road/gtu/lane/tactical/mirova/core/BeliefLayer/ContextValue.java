 ...
 * <p>
 * This class acts as a generic container for atomic pieces of "world knowledge" in <b>Layer 1 (Perception & Context)</b> of the
 * MiRoVA architecture. It supports any Java type, including strictly typed physical units (e.g., {@code Speed}, {@code Length}
 * from DJUnits), primitives, or enumerations.
 * </p>
 * <p>
