 ...
 * <p>
 * Context categories form the foundation of <b>Layer 1 (Perception & Context)</b> in the MiRoVA architecture. They manage the
 * "world knowledge" of the agent by structuring raw sensor data into semantic contexts (e.g., Ego, Neighbors, Infrastructure).
 * </p>
 * <p>
