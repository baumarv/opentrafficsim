 ...
 * <p>
 * Forms the core of <b>Layer 2 (Cognition / Motivation)</b> in the MiRoVA architecture. A KnowledgeChunk corresponds to an
 * ACT-R "chunk" of declarative knowledge. It provides mechanisms to:
 * <ul>
 ...
 * <li>Contribute to the overall driving desire (e.g., LMRS-style components: route following, overtaking, keeping right,
 * cooperation).</li>
 * </ul>
 * Critically, in accordance with the 4-layer architecture, KnowledgeChunks strictly compute <b>desires</b>, not actions.
 * Procedural actions are handled separately by ManeuverPatterns in Layer 4.
 * </p>
 * <p>
 ...
 */
public abstract class DesireIncentive
{
     ...
     */
    public DesireIncentive(final MirovaTacticalPlanner vehicle) throws OperationalPlanException
    {
        this.vehicle = vehicle;
        this.desire = Desire.zero();

        this.infrastructurePerception = vehicle.getPerception().getPerceptionCategory(DirectInfrastructurePerception.class);
        this.trafficPerception = vehicle.getPerception().getPerceptionCategory(AnticipationTrafficPerception.class);
        this.egoPerception = vehicle.getPerception().getPerceptionCategory(DirectEgoPerception.class);
        this.neighborsPerception = vehicle.getPerception().getPerceptionCategory(DirectNeighborsPerception.class);
        this.directDefaultSimplePerception = vehicle.getPerception().getPerceptionCategory(DirectDefaultSimplePerception.class);
