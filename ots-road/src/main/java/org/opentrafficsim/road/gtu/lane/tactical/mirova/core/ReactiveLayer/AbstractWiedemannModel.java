 ...
 * <li>the four regime methods: {@link #regimeTooClose}, {@link #regimeClosingSpeedTooHigh},
 * {@link #regimeFollowingOscillation}, {@link #regimeFreeDriving}</li>
 * </ul>
 * <p>
...
public abstract class AbstractWiedemannModel extends AbstractCarFollowingModel
{
        ...
        /**
         * Construct an abstract Wiedemann model. * @param headway desired headway model (Wiedemann models typically override
         * SDXC anyway)
         * @param desiredSpeed desired speed model
         * @param stream optional stochastic stream; can be null for deterministic models
         */
        protected AbstractWiedemannModel(final DesiredHeadwayModel headway, final DesiredSpeedModel desiredSpeed,
        ...
        /*
         * ======================================================================================= ABSTRACT THRESHOLD
         * COMPUTATION HOOKS Every Wiedemann model must define its own thresholds.
         * =======================================================================================
         */

        /**
         * Computes SDXC – minimum safe following distance. * @param p the parameter set
         ...
         */
        protected abstract Length computeSdxc(Parameters p, Speed dv, Speed vFollower, Speed vLeader) throws ParameterException;

        /**
         * Computes SDXO – upper threshold distance for following zone. * @param p the parameter set
         * @param sdxc the pre-computed SDXC threshold
         * @return the computed SDXO length
         * @throws ParameterException if a required parameter is missing
         */
        protected abstract Length computeSdxo(Parameters p, Length sdxc) throws ParameterException;

        /**
         * Computes SDXV – threshold for closing-speed-based braking. * @param sdxo the pre-computed SDXO threshold
         * @param p the parameter set
         * @param dv relative speed (leader - follower)
         * @return the computed SDXV length
         * @throws ParameterException if a required parameter is missing
         */
        protected abstract Length computeSdxv(Length sdxo, Parameters p, Speed dv) throws ParameterException;

        /**
         * Computes SDV – perceived speed-difference threshold. * @param p the parameter set
         * @param dx actual gap distance
         * @return the computed SDV speed
         * @throws ParameterException if a required parameter is missing
         */
        protected abstract Speed computeSdv(Parameters p, Length dx) throws ParameterException;

        /**
         * Computes SDVC – dv-threshold for emergency braking. * @param sdv pre-computed SDV threshold
         * @param p the parameter set
         * @param vLeader speed of the leader
         * @return the computed SDVC speed
         * @throws ParameterException if a required parameter is missing
         */
        protected abstract Speed computeSdvc(Speed sdv, Parameters p, Speed vLeader) throws ParameterException;

        /**
         * Computes SDVO – dv-threshold for oscillatory following. * @param sdv pre-computed SDV threshold
         * @param p the parameter set
         * @param vFollower speed of the follower (ego)
         * @return the computed SDVO speed
         * @throws ParameterException if a required parameter is missing
         */
        protected abstract Speed computeSdvo(Speed sdv, Parameters p, Speed vFollower) throws ParameterException;
        ...
        /**
         * Computes the acceleration in Wiedemann Regime A: "Too Close" — defensive deceleration.
         * <p>
         ...
         * @throws ParameterException if a required parameter is missing
         */
        protected abstract Acceleration regimeTooClose(Parameters p, Length dx, Speed dv, Length sdxc, Speed sdvo,
                        Speed vFollower, Acceleration leaderAcc) throws ParameterException;

        /**
         * Computes the acceleration in Regime B: emergency-ish braking when closing speed is too large.
         * @param p the parameter set
         * @param dx actual gap
         * @param dv relative speed (leader - follower)
         * @param sdxc threshold SDXC
         ...
         * @throws ParameterException if a required parameter is missing
         */
        protected abstract Acceleration regimeClosingSpeedTooHigh(Parameters p, Length dx, Speed dv, Length sdxc)
                        throws ParameterException;

        /**
         * Computes the acceleration in Regime f: oscillatory following (acc/dec around leader dynamics).
         * @param p the parameter set
         * @param dx actual gap
         * @param dv relative speed (leader - follower)
         ...
         * @throws ParameterException if a required parameter is missing
         */
        protected abstract Acceleration regimeFollowingOscillation(Parameters p, Length dx, Speed dv, Length sdxo,
                        Speed vFollower, Speed vDesired, Acceleration leaderAcc) throws ParameterException;

        /**
         * Computes the acceleration in Regime w: free acceleration toward desired speed.
         * @param p the parameter set
         * @param dx actual gap
         * @param dv relative speed (leader - follower)
         * @param sdxo upper following threshold SDXO
         ...
         * @throws ParameterException if a required parameter is missing
         */
        protected abstract Acceleration regimeFreeDriving(Parameters p, Length dx, Speed dv, Length sdxo, Speed vFollower,
                        Speed vDesired) throws ParameterException;

        /*
         * ======================================================================================= MAIN ENTRY POINT – identical
         * for all Wiedemann models =======================================================================================
         */

        @Override
        protected final Acceleration followingAcceleration(final Parameters p, final Speed vFollower, final Speed vDesired,
                        final Length ignoredHeadway, final PerceptionIterable<? extends Headway> leaders)
                        throws ParameterException
        {
                /*
                ...
                Acceleration aLeader = (L.getAcceleration() == null) ? Acceleration.instantiateSI(0) : L.getAcceleration();
