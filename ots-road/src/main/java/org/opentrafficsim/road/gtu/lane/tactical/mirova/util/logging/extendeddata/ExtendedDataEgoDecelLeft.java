 ...
 * the ego vehicle would experience if it merged into the left lane, as evaluated by the {@link NeighborsContext}.
 * </p>
 * <p>
...
public class ExtendedDataEgoDecelLeft extends ExtendedDataAcceleration<GtuData>
{
    ...
    public FloatAcceleration getValue(final GtuData gtu)
    {
        if (gtu instanceof GtuDataRoad road)
        {
            ...
            {
                Acceleration decel = p.getContext(NeighborsContext.class).getCachedValue(NeighborsContext.EGO_DECEL_LEFT,
                        Acceleration.class);
