 ...
 * <p>
 * This class contains ONLY the model-specific formulas and thresholds. All generic structure, regime selection, free-driving
 * logic, and perception handling is inherited from {@link AbstractWiedemannModel}.
 * </p>
 * <p>
...
public class Wiedemann99 extends AbstractWiedemannModel
{
     ...
     */
    public Wiedemann99(final DesiredHeadwayModel headway, final DesiredSpeedModel vDesired, final StreamInterface stream)
    {
    ...
    /*
     * ====================================================================================== THRESHOLD COMPUTATIONS (SDXC,
     * SDXO, SDXV, SDV, SDVC, SDVO) ======================================================================================
     */

    @Override
    protected Length computeSdxc(final Parameters p, final Speed dv, final Speed vFollower, final Speed vLeader)
    ...
    @Override
    protected Length computeSdxv(final Length sdxo, final Parameters p, final Speed dv) throws ParameterException
    {
        Duration cc3 = p.getParameter(CC3);
        Speed cc4 = p.getParameter(CC4);

        return Length.instantiateSI(sdxo.si + cc3.si * (dv.si - cc4.si));
    }
    ...
    @Override
    protected Speed computeSdvo(final Speed sdv, final Parameters p, final Speed vFollower) throws ParameterException
    {
        Speed cc5 = p.getParameter(CC5);
        return (vFollower.si > cc5.si) ? Speed.instantiateSI(sdv.si + cc5.si) : sdv;
    }
    ...
    @Override
    protected Acceleration regimeTooClose(final Parameters p, final Length dx, final Speed dv, final Length sdxc,
            final Speed sdvo, final Speed vFollower, final Acceleration leaderAcc) throws ParameterException
    {
    ...
    @Override
    protected Acceleration regimeClosingSpeedTooHigh(final Parameters p, final Length dx, final Speed dv, final Length sdxc)
            throws ParameterException
    {
        double dvSI = dv.si;
        double dxSI = dx.si;
    ...
    @Override
    protected Acceleration regimeFollowingOscillation(final Parameters p, final Length dx, final Speed dv, final Length sdxo,
            final Speed vFollower, final Speed vDesired, final Acceleration leaderAcc) throws ParameterException
    {
        Acceleration cc7 = p.getParameter(CC7);
    ...
    @Override
    protected Acceleration regimeFreeDriving(final Parameters p, final Length dx, final Speed dv, final Length sdxo,
            final Speed vFollower, final Speed vDesired) throws ParameterException
    {
