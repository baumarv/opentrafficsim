package org.opentrafficsim.road.gtu.lane.tactical.mirova.core.IntentionLayer.ManeuverPatterns.old.parallel;
 ...
 * continuously runs alongside standard car-following behavior to actively decelerate the ego vehicle on an on-ramp if the
 * target lane is congested. This ensures a smooth merging process and avoids abrupt braking at the lane drop.
 * </p>
 * <p>
...
public class AnticipatingUpstreamMergingSpeedPattern extends ManeuverPattern
{
     ...
     * <p>
     * Context check ensures that the pattern is only active when the ego lane ends within the extended look-ahead distance.
     * </p>
     ...
     * <p>
     * Ability check ensures that the pattern is only active if the prevailing speed on the target lane is below the congestion
     * threshold, indicating that proactive speed adaptation is beneficial for a smooth merge.
     * </p>
    ...
    public static class AnticipatingSpeedState extends ActionState
    {
         ...
         * <p>
         * No specific abort behavior needed for this pattern, as it will simply be deactivated by the tactical planner when
         * context conditions are no longer met.
         * </p>
