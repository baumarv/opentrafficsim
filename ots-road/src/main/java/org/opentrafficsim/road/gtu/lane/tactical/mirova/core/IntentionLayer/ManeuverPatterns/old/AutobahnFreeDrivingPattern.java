...
// import
// org.opentrafficsim.road.gtu.lane.tactical.mirova.core.ManeuverPatterns.DiscretionaryLaneChangePatternOld.ActionStateCompleteLaneChange;
...
// }
//
// public FreeDrivingState(final ManeuverPattern pattern, final LateralDirectionality lastLaneChangeDirection) throws
// ParameterException {
// super(pattern);
// this.D_FREE = pattern.getKnowledgeChunk().getMirovaTacticalPlanner().getDFree();
...
// // System.out.println(this.vehicle.getGtu().getId() + ": Preventing right-side overtaking by decelerating to fall behind
// left-lane vehicle.");
...
// */
// @Override
// public SimpleOperationalPlan next() throws ParameterException, NullPointerException, IllegalArgumentException, GtuException,
// NetworkException {
