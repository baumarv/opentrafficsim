 ...
 * <p>
 * This class is a core component of the MiRoVA arbitration layer. It allows the arbitrator to evaluate multiple proposed plans
 * while retaining the exact source pattern and state that generated the winning proposal.
 * </p>
 * <p>
...
public class ScoredOperationalPlan implements Serializable, Comparable<ScoredOperationalPlan>
{
    ...
    /**
     * Constructs a new scored operational plan. * @param operationalPlan SimpleOperationalPlan; the physical plan proposed by
     * the pattern
    ...
    /**
     * Retrieves the underlying simple operational plan. * @return SimpleOperationalPlan; the physical plan to be executed
     */
    ...
    /**
     * Retrieves the utility score of this plan. * @return double; the evaluated utility
     */
    ...
    /**
     * Retrieves the maneuver pattern that generated this plan. * @return ManeuverPattern; the source pattern
     */
    ...
    /**
     * Retrieves the action state that generated this plan. * @return ActionState; the source state
     */
     ...
     * @return int; a negative integer, zero, or a positive integer as this plan's utility is less than, equal to, or greater
     *         than the specified plan's utility
     */
    @Override
