 ...
 * <p>
 * Forms a part of <b>Layer 1 (Perception & Context)</b> in the MiRoVA architecture. This includes average speeds and densities
 * on the current and adjacent lanes. The information is lazily evaluated and cached once per simulation tick.
 * </p>
 * <p>
 * These macroscopic quantities can be used for higher-level tactical reasoning, such as evaluating flow conditions, cooperative
 * behavior, or capacity effects.
 * </p>
 * <p>
...
public class MacroTrafficContext extends ContextCategory implements UpdatableContext
{
     ...
     * <p>
     * Uses the {@link TrafficPerception} category to retrieve the instantaneous, lane-aggregated mean speed. If unavailable,
     * returns {@code NaN}.
     * </p>
     ...
     * <p>
     * Uses {@link TrafficPerception} to retrieve the instantaneous macroscopic density. Returns NaN if perception data are not
     * available.
     * </p>
     ...
     * <p>
     * Wrapper around lane-specific accessors that generalizes lookup for {@link RelativeLane#CURRENT},
     * {@link RelativeLane#LEFT}, and {@link RelativeLane#RIGHT}.
     * </p>
     ...
     */
    public LinearDensity getDensity(final RelativeLane lane) throws OperationalPlanException, ParameterException
    {
     ...
     * <p>
     * Wrapper for generalized access, used for convenience in tactical reasoning logic.
     * </p>
     ...
     * @throws IllegalArgumentException if the lane is unsupported
     */
    public Speed getAverageSpeed(final RelativeLane lane) throws OperationalPlanException, ParameterException
    {
        if (lane.equals(RelativeLane.CURRENT))
        {
     ...
     * @throws OperationalPlanException if perception access fails
     */
    private LinearDensity computeDensity(final RelativeLane lane) throws OperationalPlanException, ParameterException
    {
        TrafficPerception trafficPerception = this.vehicle.getPerception().getPerceptionCategory(TrafficPerception.class);
     ...
     * <p>
     * This context uses lazy evaluation and thus does not update any data preemptively. Values are recomputed on demand when
    ...
    {
        return "MacroTrafficContext[" + "avgSpeedCurrent=" + getCachedValue(AVG_SPEED_CURRENT, Speed.class)
