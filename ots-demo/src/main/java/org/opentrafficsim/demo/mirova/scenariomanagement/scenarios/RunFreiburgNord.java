...
public class RunFreiburgNord
{
    ...
    public static void main(final String[] args) throws Exception
    {
        for (int run = 0; run < 1; run++)
        {
            ...
            params.set("demandStartDate", "2025-10-07 15:20:00");
            params.set("demandEndDate", "2025-10-07 17:30:00");
            params.set("demandAggregation", 2); // 1-minute aggregation for minute-by-minute demand

            // Define parameters directly analogously to RunFreiburgParallel
            params.set("car." + ParameterTypes.T.getId(), 1.6);
