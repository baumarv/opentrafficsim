...
import org.opentrafficsim.demo.mirova.scenariomanagement.scenarios.FreiburgCapacityDropStudy;
...
import org.opentrafficsim.demo.mirova.scenariomanagement.scenarios.TamaRampEndStudy;
...
import org.opentrafficsim.demo.mirova.scenariomanagement.scenarios.VGainGridStudy;
import org.opentrafficsim.demo.mirova.scenariomanagement.scenarios.FreiburgProductionStudy;
import org.opentrafficsim.demo.mirova.scenariomanagement.scenarios.FreiburgRelaxationStudy;
...
import org.opentrafficsim.demo.mirova.scenariomanagement.scenarios.FreiburgSusceptibilityStudy;
...
public final class StudyRegistry
{
    ...
    static
    {
        ...
        STUDIES.put("vgaintau", VGainRelaxationSensitivityStudy.class);
        ...
        STUDIES.put(TamaRampEndStudy.NAME, TamaRampEndStudy.class);
        STUDIES.put(TamaRampEndCalibrationStudy.NAME, TamaRampEndCalibrationStudy.class);
        STUDIES.put(TamaHeadwayDampingStudy.NAME, TamaHeadwayDampingStudy.class);
        ...
        STUDIES.put(TamaFinalValidationStudy.NAME, TamaFinalValidationStudy.class);
